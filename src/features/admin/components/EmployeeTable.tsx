        ...
        {employees.map((emp) => (
          ...
          >
            ...
            <div className="employee-card__footer">
              {!isReadOnly && (
                <button
                  className="employee-card__btn employee-card__btn--edit"
                  onClick={() => onEdit(emp)}
                  title="Редактирай служител"
                >
              ...
              {!isReadOnly && emp.role !== 'admin' && !emp.is_former && (
                <button
              ...
              {!isReadOnly && emp.is_former && (
                <button
                  className="employee-card__btn employee-card__btn--delete"
                  onClick={() => onDelete(emp)}
                  disabled={actionLoading === emp.id}
                  title="Изтрий служител завинаги"
                >
                  {actionLoading === emp.id ? (
                    <>
                      <div className="employee-card__btn-spinner" />
